...
class _EdukasiScreenState extends State<EdukasiScreen> {
  ...
  Widget build(BuildContext context) {
    final edukasiList = EdukasiData.getEdukasi();
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'Pelajari topik penting seputar diabetes dengan tampilan yang lebih ringkas dan nyaman dibaca.',
            style: TextStyle(
              fontFamily: 'Poppins',
              fontSize: 13,
            ...
            return Padding(
              ...
              child: Align(
                ...
                child: ConstrainedBox(
                  ...
                  child: _buildEdukasiCard(context, edukasi),
                ),
              ),
            );
          }),
  ...
  Widget _buildEdukasiCard(BuildContext context, EdukasiModel edukasi) {
    final Color cardColor = _getColorFromString(edukasi.color);
    final preview = edukasi.description;
    final isDarkColor = edukasi.color == 'blue' ||
        edukasi.color == 'red' ||
        edukasi.color == 'purple';
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => EdukasiDetailScreen(edukasi: edukasi),
          ),
        );
      },
